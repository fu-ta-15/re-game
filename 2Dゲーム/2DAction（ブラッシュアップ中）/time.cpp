...
HRESULT InitTime(void)
{
	...
	//テクスチャの読み込み
	D3DXCreateTextureFromFile(pDevice, "data\\TEXTURE\\cunt00.png", &g_pTextureTime);
	...
	for (int nCntTime = 0; nCntTime < MAX_TIME; nCntTime++)
	{
		...
		//各頂点座標
		pVtx[0].pos = D3DXVECTOR3(550 + ((float)nCntTime * 50), 50, 0.0f);
		pVtx[1].pos = D3DXVECTOR3(550 + ((float)nCntTime * 50), 10, 0.0f);
		pVtx[2].pos = D3DXVECTOR3(600 + ((float)nCntTime * 50), 50, 0.0f);
		pVtx[3].pos = D3DXVECTOR3(600 + ((float)nCntTime * 50), 10, 0.0f);
