...
#define GROUND_POS			(15)								// 地面の高さ
#define TEXTURE_PLAYER_X	(4)									// テクスチャｘの分割数
#define TEXTURE_PLAYER_Y	(2)									// テクスチャyの分割数
#define MAX_RIGTH			(3000)
#define MAX_LEFT			(-3000)
#define BROCK_RIGTH			(D3DXVECTOR3(-3.0f,0.0f,0.0f))
#define BROCK_LEFT			(D3DXVECTOR3(3.0f,0.0f,0.0f))
...
HRESULT InitPlayer(void)
{
	...
	// テクスチャの読み込み
	D3DXCreateTextureFromFile(pDevice, "data\\TEXTURE\\player000.png", &g_pTexturePlayer);	// プレイヤー１
	...
	// 初期の場所に戻す
	g_Player.pos = D3DXVECTOR3(SCREEN_WIDTH / 2, 400 - LENGTH_PLAYER_Y, 0.0f);
...
void UpdatePlayer(void)
{
	...
	if (g_Player.pos.y + LENGTH_PLAYER_Y > 400)
	{// 縦の範囲
		g_Player.move.y = 0.0f;
		g_Player.pos.y = 400 - LENGTH_PLAYER_Y;
		pPlayer->Junp = false;
	}
