...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------//
#define MAX_SCORE			(6)
#define SCORE_STZEX			(50)
#define SCORE_SIZEXX		(80)
...
HRESULT InitScore(void)
{
	...
	for (int nCntBullet = 0; nCntBullet < MAX_SCORE; nCntBullet++)
	{
		...
		//各頂点座標
		pVtx[0].pos = D3DXVECTOR3(SCORE_STZEX + ((float)nCntBullet * 40), 200, 0.0f);
		pVtx[1].pos = D3DXVECTOR3(SCORE_STZEX + ((float)nCntBullet * 40), 170, 0.0f);
		pVtx[2].pos = D3DXVECTOR3(SCORE_SIZEXX + ((float)nCntBullet * 40), 200, 0.0f);
		pVtx[3].pos = D3DXVECTOR3(SCORE_SIZEXX + ((float)nCntBullet * 40), 170, 0.0f);
