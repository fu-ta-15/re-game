...
void DrawPlayerInfo(void)
{
	...
	ImGui::Text("============================== \n");
	ImGui::Text("==========MODEL_[0]========== \n");
	ImGui::Text("MODEL_MIN : (X:%.2f Z:%.2f) \n", pPlayer->aModel[0].g_VtxMinModel.x, pPlayer->aModel[0].g_VtxMinModel.z);
	ImGui::Text("MODEL_MAX : (X:%.2f Z:%.2f) \n", pPlayer->aModel[0].g_VtxMaxModel.x, pPlayer->aModel[0].g_VtxMaxModel.z);
	ImGui::Text("============================== \n");
