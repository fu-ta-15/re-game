...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------//
#define MAX_TIME			(3)
#define TIME_START			(120)	
#define POLY_DISTANCE		(50.0f)
#define ADD_TIMER			(60)
...
HRESULT InitTime(void)
{
	...
	//頂点バッファの生成
	if (FAILED(pDevice->CreateVertexBuffer(sizeof(VERTEX_2D) * NUM_VERTEX * MAX_TIME, D3DUSAGE_WRITEONLY, FVF_VERTEX_2D, D3DPOOL_MANAGED, &g_pVtxBuffTime, NULL)))
	{
		return E_FAIL;
	}
	...
	for (int nCntTime = 0; nCntTime < MAX_TIME; nCntTime++)
	{
		...
		//各頂点座標
		pVtx[0].pos = D3DXVECTOR3(550 + ((float)nCntTime * POLY_DISTANCE), 0 + 110, 0.0f);
		pVtx[1].pos = D3DXVECTOR3(550 + ((float)nCntTime * POLY_DISTANCE), 0 + 10, 0.0f);
		pVtx[2].pos = D3DXVECTOR3(600 + ((float)nCntTime * POLY_DISTANCE), 0 + 110, 0.0f);
		pVtx[3].pos = D3DXVECTOR3(600 + ((float)nCntTime * POLY_DISTANCE), 0 + 10, 0.0f);
