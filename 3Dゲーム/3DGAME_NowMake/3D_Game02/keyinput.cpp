...
{
	return (g_aKeyStateTrigger[nKey] & 0x80) ? true : false;	// トリガー
}
bool GetKeyboardPresse(int nKey)
{
	return (g_aKeyStatePresse[nKey] & 0x80) ? true : false;		// プレス
}
bool GetKeyboardRelease(int nKey)
{
	return (g_aKeyStateRelease[nKey] & 0x80) ? true : false;	// リリース
}
